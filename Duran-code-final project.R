...
genders <- c(
  off.attrb.2017$off_gender[match(actor_ids, off.attrb.2017$off_id)]
)

vcol <- genders
vcol[genders == "Male"] <- "green"
vcol[genders == "Female"] <- "red"
...
# Define colors for males and females
officer_colors <- ifelse(officer_genders == "Male", "lightblue", "pink")
...
>>>>>>> 292b053bc92fe01a83551d8166ffd5fc658764fb
